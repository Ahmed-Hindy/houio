...
- [ ] Split faithful HouGeo schema loading by attributes, polygons/curves, packed records, and volumes; attributes/groups and packed records now have focused modules, while curve, quadric, and native VDB decoding live in `HouGeoPrimitiveLoad.cpp`.
